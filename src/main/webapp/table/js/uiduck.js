...
var uiduck = function (o, e) {
    var uiduck = {
        ...
        showLoading: function (e) {
            ...
            var loadingHtml = '<img id="' + uiduck.templateId + '-ud-loading" style="position: absolute;' + position + ';width: ' + Width + '; height: ' + Width + '; z-index: 1003" src="../../table/assets/' + uiduck.loading.icon + '.gif" />';
