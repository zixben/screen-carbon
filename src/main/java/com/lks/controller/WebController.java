...
public class WebController {
	...
	public String movies(Model model, HttpSession session,
		...
		model.addAttribute("styles", "/assets/css/movies.css?v=media-page-search-1");

		if (toggleState) {

			model.addAttribute("scripts", "/assets/js/moviesClimateRated.js?v=media-page-search-1");
		} else {

			model.addAttribute("scripts", "/assets/js/moviesTMDB.js?v=media-page-search-1");
		}
	...
	public String tvShows(Model model, HttpSession session,
		...
		if (toggleState) {
			model.addAttribute("scripts", "/assets/js/tvClimateRated.js?v=media-page-search-1");
		} else {

			model.addAttribute("scripts", "/assets/js/tvTMDB.js?v=media-page-search-1");
		}
	...
	public String login(Model model, HttpServletRequest request) {
		...
		model.addAttribute("scripts", "/assets/js/login.js?v=auth-pages-4");
